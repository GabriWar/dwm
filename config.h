...
static char *fonts[]          = { "cozette","monospace:size=12","ttf-dejavu", "JoyPixels:pixelsize=10:antialias=true:autohint=true"  };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_Tab,		spawn,		SHCMD("light -A 25; kill -47 $(pidof dwmblocks)") },
	...
	{ MODKEY|ShiftMask,		XK_x,		spawn,		SHCMD("google-chrome-stable") },
	/* { MODKEY,			XK_c,		spawn,		SHCMD("") }, */
	/* { MODKEY|ShiftMask,		XK_c,		spawn,		SHCMD("") }, */
	/* V is automatically bound above in STACKKEYS */
	{ MODKEY,			XK_b,		togglebar,	{0} },
	/* { MODKEY|ShiftMask,		XK_b,		spawn,		SHCMD("") }, */
	{ MODKEY,			XK_n,		spawn,		SHCMD(TERMINAL " -e micro") },
	...
	{ 0, XF86XK_MonBrightnessUp,	spawn,		SHCMD("light -A 10; kill -47 $(pidof dwmblocks)") },
	{ 0, XF86XK_MonBrightnessDown,	spawn,		SHCMD("light -U 10; kill -47 $(pidof dwmblocks)") },
...
#endif
	{ ClkStatusText,        ShiftMask,      Button3,        spawn,          SHCMD(TERMINAL " -e micro ~/.local/src/dwmblocks/config.h") },
